...
{
    public partial class RepTicketsDetalleMinutos : System.Web.UI.Page
    {
        ...
        private void MostrarPolizas()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = @"Reportes\RepTicketsDetalleMinutos.rdlc";

            ObjectDataSource objDS = new ObjectDataSource("ZOE.OrdenesServicio.Negocio.ReporteBC", "ObtenerTicketsDetalleMinutos");
            objDS.SelectParameters.Add("clienteId", System.Data.DbType.Int16, clienteId);
            objDS.SelectParameters.Add("proyectoId", System.Data.DbType.Int16, proyectoId);
