<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepTicketsDetalleMinutos.aspx.cs" Inherits="ZOE.OrdenesServicio.Reportes.RepTicketsDetalleMinutos" %>
...
<body style="padding: 5px 5px 5px 5px;">
    ...
    <asp:scriptmanager ID="Scriptmanager1" runat="server"></asp:scriptmanager>
        ...
        <div style="width:1131px; border-style:solid; border-width:thin; background-color:#FFFFF0; font-size: 1.00em; font-family:"
