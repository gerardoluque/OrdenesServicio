...
{
    public partial class RepAsesorHoras : System.Web.UI.Page
    {
        ...
        public void Mostrar()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = @"Reportes\RepAsesorHoras.rdlc";

            ObjectDataSource objDS = new ObjectDataSource("ZOE.OrdenesServicio.Negocio.ReporteBC", "ObtenerTotalHorasAsesoresPorFecha");
            string fechaIni = "";
            string fechaFin = "";
