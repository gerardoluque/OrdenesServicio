...
{
    public partial class RepAsesorActividadesPorDia : System.Web.UI.Page
    {
        ...
        public void Mostrar()
        {
            ...
            ReportViewer1.LocalReport.ReportPath = @"Reportes\RepAsesorActividadesPorDia.rdlc";

            ObjectDataSource objDS = new ObjectDataSource("ZOE.OrdenesServicio.Negocio.ReporteBC", "ObtenerActividadesAsesoresPorFecha");
            string fechaIni = "";
            string fechaFin = "";
