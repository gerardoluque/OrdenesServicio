<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepClienteTicketsPrioridades.aspx.cs" Inherits="ZOE.OrdenesServicio.Reportes.RepClienteTicketsPrioridades" %>
    ...
    <form id="form1" runat="server">
        ...
        <div style="width:977px; border-style:solid; border-width:thin; background-color:#FFFFF0; font-size: 1.00em; font-family:"
            Trebuchet MS" , Verdana, Helvetica, Sans-Serif;">
              ...
              <div style="padding-bottom:10px; padding-top:5px; padding-left:5px;">
                ...
                <div style="display:inline-block; padding-left:32px;">
                    <asp:DropDownList ID="ddlProyecto" runat="server" Height="22px" Width="249px">
                    </asp:DropDownList>
                </div>
                <div style="display:inline-block">
                    <asp:CheckBox ID="chkTodosProyecto" runat="server" Text="Todos"  Checked="true" />
                </div>
            </div>
            ...
            <div style="padding-bottom:10px; padding-top:5px; padding-left:5px;">
                ...
                <div style="display:inline-block">
                    <asp:CheckBox ID="chkTodos" runat="server" Text="Todos"  Checked="true" />
                </div>
            </div>
            ...
            <div style="padding-left:5px; padding-top:5px; padding-bottom:10px;">
                ...
                <div style="display:inline-block; padding-left:13px;">
                    <input runat="server"  type="text" id="txtTicket" />
                </div>
                <div style="display:inline-block">
                    <asp:CheckBox ID="chkTodosTicket" runat="server" Text="Todos"  Checked="true"/>
                </div>
            </div>

            <div style="padding-bottom:15px; padding-left:5px; display:inline-block">
                <asp:Button ID="btnVerReporte" runat="server" Text="Ver Reporte" 
                    onclick="btnVerReporte_Click" />
            </div>
        </div>
        <rsweb:ReportViewer ID="RepClienteTicketsPrioridad" runat="server"
           Height="800px" Width="1224px" Font-Names="Verdana" Font-Size="8pt" 
            InteractiveDeviceInfos="(Collection)" WaitMessageFont-Names="Verdana" 
            WaitMessageFont-Size="14pt" BorderStyle="Solid" BorderWidth="1px" SizeToReportContent="True" ShowWaitControlCancelLink="True">
        </rsweb:ReportViewer>
    </form>
</body>
</html>
